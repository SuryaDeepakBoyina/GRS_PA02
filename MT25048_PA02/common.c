/*
 * common.c - Implementation of common utilities for PA02 Network I/O Analysis
 * Roll Number: MT25048
 */
...
void stats_print(stats_t *stats, const char *label) {
    ...
    double throughput_gbps = calculate_throughput_gbps(stats->total_bytes, duration_sec);
    double avg_latency_us = (stats->total_messages > 0) ? 
                            (stats->total_latency_us / stats->total_messages) : 0.0;
